...
public:
	...
	UIPager(const std::vector<boost::shared_ptr<uis::UIBase> > &page_list, boost::shared_ptr<const std::wstring> arrow_enable_path, boost::shared_ptr<const std::wstring> arrow_disble_path);
	~UIPager();
