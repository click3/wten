...
void TempleScene::Initialize(void) {
...
TempleScene::TempleScene(boost::shared_ptr<const std::wstring> default_frame_filename) :
...
TempleScene::TempleScene(boost::shared_ptr<const Graph> default_frame_graph) :
